...
| Version | 1.28 |
| Date | 2026-09-27 |
| Repo HEAD | `5cd78f0` (Tahap 1 integritas test + fix xe(0) + bump v15.28) |
...
|------|-------|--------------|
| Git HEAD | `5cd78f0` (Tahap 1 integritas test + fix xe(0) + bump v15.28) | — |
| Working tree | clean | — |
...
| Suite L1 in-repo | `tests/l1/` **30** suite · `npm run test:l1` · **assertion floor aktif** (suite 0-assert = FAIL) | **L1 PASS 722/0** (2026-09-27; naik dari 560 karena 4 suite 0-assert kini jadi suite nyata) |
...
- [ ] **Tahap 2 — Harness `Code.gs` eksekutabel** (VM sandbox + fake SpreadsheetApp/CacheService/LockService/Utilities; suite `gs_trx`/`gs_auth`/`gs_stok`/`gs_aset`) — prasyarat aman untuk memperbaiki 6 ACCEPTED LIMITATION backend
- [ ] **Tahap 3 — Fix integritas transaksi** (OFF-01 outbox, BE-04 baca-vs-recalc, BE-01 KDF, BE-02 rate limit) — butuh approval deploy
- [ ] F-06+ (P3 antrian)  
