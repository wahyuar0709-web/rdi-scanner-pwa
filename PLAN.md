...
| Version | 1.27 |
| Date | 2026-09-26 |
| Repo HEAD | `ae0dd11` (Fix 2 bug user: HP cetak + sesi resume/idle 2 jam + bump v15.27) |
| App version | `v15.27` / SW `rdi-stok-v35` / GAS deployment `@41` |
...
|------|-------|--------------|
| Git HEAD | `ae0dd11` (Fix 2 bug user + bump v15.27) | — |
| Working tree | clean | — |
| `APP_VERSION` | `v15.27` (source of truth + title/apple/css/js/topbar sinkron) | L1 PASS |
| `APP_BUILD_DATE` | `2026-09-26` | L1 |
| SW `CACHE` | `rdi-stok-v35` (`sw.js:1`) + precache `./js/util.js` + `./js/cetak.js` + `./js/outbox.js` + `./js/format.js` + `./js/jspdf.min.js` | L1+L2 |
...
| Suite L1 in-repo | `tests/l1/` **30** suite · `npm run test:l1` | **L1 PASS 560/0** (2026-09-26, pre & post-bump) |
| Suite L2 in-repo | `tests/l2/` 7 suite · `npm run test:l2` | **L2 PASS 308/0** (2026-09-26, pre & post-bump) |
